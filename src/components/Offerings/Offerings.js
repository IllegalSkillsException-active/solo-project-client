                ...
                <div className="pricing">
                    <section className="standard">
                        ...
                        <ul className="standardPricing">
                            <li className="addOn">30 Minutes / $40</li>
                            <li className="addOn">60 Minutes / $70</li>
                            <li className="addOn">75 Minutes / $85</li>
                            <li className="lastAddOn">90 Minutes / $100</li>
                        </ul>
                    ...
                    <section className="addOns">
                        ...
                        <ul className="addOns2">
                            ...
                            <li className="lastAddOn">Sauna</li>
                        </ul>
                    </section>
                    <section className="specialtyTreatments">
                        <h2 className="therapeutic"><b><u>Specialty Treatments</u></b></h2>
                        <h3>Therapeutic Massage</h3>
                        <div className = "addOnsDetail">*Clinical massage aimed to treat pain from injury or chronic condition / ailment</div>
                        <ul className="therapeuticPricing">
                            <li className="addOn">60 minutes / $80</li>
                            <li className="lastAddOn">90 minutes / $110</li>
                        </ul>
                        <h3>Somatic Coaching Session</h3>
                        <div className = "addOnsDetail">*Intuitive body mapping & localized focus massage on one or two areas to address emotional tension buildup stored in the body</div>
                        <ul className="somaticPricing">
                            <li className="addOn">30 minutes / $30</li>
                            <li className="lastAddOn">60 minutes / $60</li>
                        </ul>
                    </section>
                </div>
            </div>
